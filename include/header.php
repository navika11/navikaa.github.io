<div id="side-panel-container" class="dark" data-tm-bg-img="images/side-push-bg.jpg">
  <div class="side-panel-wrap">
    ...
    <p>True Law Association is one of the fastest-growing full-service law firm in Delhi & NCR and has followed—if not created—the blueprint for legal success.</p>
    <div class="widget">
      ...
      <div class="tm-widget-contact-info contact-info-style1 contact-icon-theme-colored1">
        <ul>
          <li class="contact-name">
            ...
            <div class="text">True Law Association </div>
          </li>
          <li class="contact-phone">
            <div class="icon"><i class="flaticon-contact-042-phone-1"></i></div>
            <div class="text"><a href="tel:+91-7065030001">+91-7065030001</a></div>
          </li>
          <li class="contact-email">
            <div class="icon"><i class="flaticon-contact-043-email-1"></i></div>
            <div class="text"><a href="mailto:info@tomarlawyers.com">info@truelaw.com</a></div>
          </li>
          <li class="contact-address">
            <div class="icon"><i class="flaticon-contact-047-location"></i></div>
            <div class="text">LAWYERS CHAMBER, F 611 6TH FLOOR KARKARDOOMA COURTS, DELHI – 110032</div>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-xl-auto header-top-left align-self-center text-center text-xl-left">
            <ul class="element contact-info">
              <li class="contact-phone"><i class="fa fa-phone font-icon sm-display-block"></i> Tel: +91-7065030001</li>
              <li class="contact-email"><i class="fa fa-envelope font-icon sm-display-block"></i> info@truelaw.com</li>
              <li class="contact-address"><i class="fa fa-map font-icon sm-display-block"></i> LAWYERS CHAMBER, F 611 6TH FLOOR KARKARDOOMA COURTS, DELHI – 110032</li>
            </ul>
          </div>
          <div class="col-xl-auto ms-xl-auto header-top-right align-self-center text-center text-xl-end">
            <div class="element pt-0 pb-0">
              <ul class="styled-icons icon-dark icon-theme-colored1 icon-circled clearfix">
                <li><a class="social-link" href="https://www.facebook.com/tomar.lawyers" ><i class="fab fa-facebook"></i></a></li>
                <li><a class="social-link" href="#" ><i class="fab fa-twitter"></i></a></li>
                <li><a class="social-link" href="#" ><i class="fab fa-youtube"></i></a></li>
              </ul>
            </div>
            <div class="element pt-0 pt-lg-10 pb-0">
              <a href="ajax-load/form-appointment.php" class="btn btn-theme-colored2 btn-flat btn-sm ajaxload-popup">Make an Appointment</a>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-sm-auto ms-auto pr-0 align-self-center">
                <nav id="top-primary-nav" class="menuzord theme-color2" data-effect="slide" data-animation="none" data-align="right">
                  <ul id="main-nav" class="menuzord-menu">
                        ...
                        <div class="megamenu-row">
                          <div  class="col3">
                            <ul class="list-unstyled list-dashed">
                              <li class="menu-item">
                                <a class="tm-submenu-title" href="index-mp-layout1.html"><span>All Main Layouts</span></a>
                            ...
                            <ul class="list-unstyled list-dashed">
                              <li class="menu-item">
                                <ul class="list-unstyled">
                                  ...
                                  <li class=""><a class=" tm-submenu-title" href="#"><span>Magazine Layouts</span> <span class="badge bg-danger">New</span></a></a></li>
                                  <li><a href="index-hot-magazine-home.html">Magazine Home Layout</a></li>
                                  <li class=""><a class=" tm-submenu-title" href="#"><span>Personal Home</span> <span class="badge bg-danger">New</span></a></a></li>
                    ...
                    <ul class="dropdown">
                            <li><a href="community.php">COMMUNITY / PRO-BONO</a></li>
                          </ul>
                    </li>
                    <li class="menu-item"><a href="practiseareas.php">Practise Areas</a>
                    <ul class="dropdown">
                            <li><a href="appeals.php">Appeals</a></li>
                            <li><a href="arbitration.php">Arbitration & Alternative Dispute Resolution</a></li>
                            <li><a href="banking.php">Banking Finance & Insurance</a></li>
                            <li><a href="corporate.php">Corporate & Commercial Practise</a></li>
                            <li><a href="employment.php">Employment, Labour & Industrial Relation</a></li>
                            <li><a href="intellectual.php">Intelluctual Property & Licensing</a></li>
                            <li><a href="real.php">Real Estate & Property</a></li>
                            <li><a href="startup.php">Startups</a></li>
                        

                          </ul>
                    <li><a href="underconstruction.php">Media & Publications</a></li>
                            ...
                            <ul class="list-unstyled list-dashed">
                              <li class="menu-item">
                                ...
                                <ul class="list-unstyled">
                                  ...
                                  <li><a href="shortcode-columns-grids.html"><i class="fas fa-columns"></i> Columns Grids</a></li>
              ...
              <div class="col-sm-auto align-self-center nav-side-icon-parent">
                <ul class="list-inline nav-side-icon-list">
                  <!-- <li class="hidden-mobile-mode">
                      <a href="#" id="top-nav-search-btn"><i class="search-icon fa fa-search"></i>
                    </a>
                </li> -->
                  <li class="hidden-mobile-mode">
                    <!-- <div class="top-nav-mini-cart-icon-container">
                      <div class="top-nav-mini-cart-icon-contents">
                        <a class="mini-cart-icon" href="shop-cart.html" title="View your shopping cart"><i class="fa fa-shopping-cart"></i><span class="items-count">1</span> <span class="cart-quick-info">1 item - <span class="amount"><span class="currencySymbol">&pound;</span>18.00</span></span></a>
