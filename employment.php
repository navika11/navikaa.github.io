            ...
            <div class="col-md-12 text-center">
              ...
              <nav role="navigation" class="breadcrumb-trail breadcrumbs">
                <div class="breadcrumbs">
                  ...
                  EMPLOYMENT, LABOUR & INDUSTRIAL RELATION</span>
                </div>
              </nav>
            </div>
          </div>
            ...
            <div class="blog-posts single-post">
              <article class="post clearfix mb-0">
                <div class="entry-header mb-30">
                  <div class="post-thumb thumb"> <img src="images/IMG/img4.jpg" alt="" class="img-responsive img-fullwidth"> </div>
                  <h3>

                  EMPLOYMENT, LABOUR & INDUSTRIAL RELATION</h3>
                ...
                <div class="entry-content">
                  <p style="text-align: justify">The Firm routinely deals with labour law cases pertaining to the Industrial Disputes Act, 1947, Minimum Wages Act, 1948, Payment of Wages Act, 1936, Payment of Gratuity Act, 1972, Workmen’s Compensation Act, 1923, etc. before the High Court of Delhi as well as the Central Administrative Tribunal, Principle Bench, Delhi. We also represent clients before Labour Courts as well as Industrial Tribunals in Delhi.</p>
