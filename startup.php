            ...
            <div class="blog-posts single-post">
              <article class="post clearfix mb-0">
                <div class="entry-header mb-30">
                  <div class="post-thumb thumb"> <img src="images/IMG/img7.jpg" alt="" class="img-responsive img-fullwidth"> </div>
                  <h3>
                ...
                <div class="entry-content">
                  <p style="text-align: justify">We at True Law Assosiation provide legal services and assistance to an array of entrepreneurs, young companies, startups, etc.  In order to access a host of tax benefits, easier compliance, IPR, etc., DPIIT recognizes eligible companies, startup venture firms, etc. as Startups based on their period of existence, innovation, scalability, etc. Our team of startup business attorneys have immense experience in assisting clients in startup funding, investing in startup companies and providing them startup legal services.<br>
</p>
