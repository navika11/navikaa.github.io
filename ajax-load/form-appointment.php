      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form id="appointment_form_popup" name="appointment_form" class="appointment-form" method="post" >
            <h3 class="mt-0">Get A quote<span class="text-theme-colored1 font-weight-600"> Now!</span></h3>
            <div class="row">
              <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="mb-3 mb-30">
                  <input name="date" class="form-control required date-picker" type="text" placeholder="Date">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="mb-3 mb-30">
                  <input name="time" class="form-control required time-picker" type="text" placeholder="Time">
                </div>
              </div>
              <div class="col-sm-12">
                <div class="mb-3">
              ...
              <div class="col-sm-12">
                <div class="mb-3 mb-0 mt-0">
                  ...
                  <input type="submit" name="submit" class="btn btn-theme-colored1 btn-round" data-loading-text="Please wait..." value="Send">
                </div>
              </div>
            </div>
          </form>
          ...
          $email=$_POST['email'];
               $html_message  =  '<h1>New Appointment Details.</h1>';
        $html_message  .=   '<p>Name : '. $_POST['name'] .'</p>';
        $html_message  .=   '<p>Email :'.$_POST['email'].'</p>';
        $html_message  .=   '<p>Phone :'.$_POST['phone'].'</p>';
