...
<div id="side-panel-container" class="dark" data-tm-bg-img="images/widgets/side-push-bg.jpg">
  <div class="side-panel-wrap">
    <div id="side-panel-trigger-close" class="side-panel-trigger"><a href="#"><i class="fa fa-times side-panel-trigger-icon"></i></a></div>
    <img class="logo mb-50" src="images/logo.png" alt="Logo">
    ...
    <div class="widget">
      ...
      <div class="latest-posts">
        <article class="post clearfix pb-0 mb-10">
          <a class="post-thumb" href="news-details.html"><img src="images/blog/s1.jpg" alt=""></a>
        ...
        <article class="post clearfix pb-0 mb-10">
          <a class="post-thumb" href="news-details.html"><img src="images/blog/s2.jpg" alt=""></a>
          <div class="post-right">
        ...
        <article class="post clearfix pb-0 mb-10">
          <a class="post-thumb" href="news-details.html"><img src="images/blog/s3.jpg" alt=""></a>
          <div class="post-right">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <!-- <h2 class="title text-white">Appeals</h2> -->
            ...
            <div class="blog-posts single-post">
              <article class="post clearfix mb-0">
                <div class="entry-header mb-30">
                  <div class="post-thumb thumb"> <img src="images/bg/bg7.jpg" alt="" class="img-responsive img-fullwidth"> </div>
                  <h3>LAWYER'S FOR DOMESTIC VIOLENCE</h3>
                  ...
                  <div class="tm-sc-unordered-list list-style12">
                      <ul>
                        <li><b><u>Siddhartha Luthra :-</u></b><br>
                        Sidharth Luthra is a senior advocate at the Supreme Court of India. He has also been the Aditional Solicitor General of India. Sidharth holds expertise in Criminal Law. He also keeps a strong hold in the field on cyber crimes. He holds a degree of MPhil in criminology from Cambridge University.
                        </li>
                        <li><b><u>Pinky Anand :-</u></b><br>
                        Pinky Anand is a Senior Advocate at the Supreme Court of India with a distinguished practice in criminal law.  She is a recipient of French National Order of Merit. When you talk of top criminal lawyers in Delhi, you cannot miss out Pinky Anand’s name. Rather she finds a spot in top criminal lawyers in India too.</li>
                        <li><b><u>Kapil Sibal :-</u></b><br>
                        Kapil Sibal started his legal journey as a lawyer in the year 1970. Thereafter, he moved to Harvard Law School to pursue his further legal education. Almost all the feats are achieved by this legal-eagle. Furthermore, in 1989 he was appointed as the Additional Solicitor General of India. Also, Kapil Sibal is honored with Padma Bhushan.</li>
                        <li><b><u>Gopal Subramanium :-</u></b><br>
                        Gopal Subramanium is a senior advocate at the Supreme Court and Delhi High Court. Also, Gopal Subramanium also served as Solicitor General Of India. He started his career with Shardull S Shroff. Later he worked with D P Wadhwa, Soli Sorabjee, and other eminent legal eagles.</li>
                        <li><b><u>Parag Tripathi :-</u></b><br>
                        Parag Tripathi has held the office of Aditional Solicitor General of India. He is a senior advocate at the Supreme Court and Delhi Court. Parag Tripathi is well know all across the bar and the bench. He holds the reputation of a well-renowned jurist. When it comes to best criminal lawyers in Delhi, no one can miss out Parag Tripathi’s name.</li>
                        <li><b><u>Mukul Rohtagi :-</u></b><br>
                        Mukul Rohtagi is the acting Attorney General of India. On Monday and Friday when miscellaneous petitions are taken before the Supreme Court, one can see Mukul Rohtagi rushing from one court to the another. Mukul Rohtagi is among one of the most sought criminal lawyers in Delhi.</li>
                      </ul>
                    </div>
                ...
                <div class="search-form">
                  <form>
                    <div class="input-group">
                      ...
                      <button type="submit" class="btn btn-theme-colored1 search-button"><i class="fa fa-search"></i></button>
                      </span>
                    </div>
                  </form>
                </div>
